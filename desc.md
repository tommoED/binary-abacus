...
- change where the binary point  to allow fractions
- add options to include 2's complement, 1's complement, and sign bit
...
- game mechanics that instruct and teach
